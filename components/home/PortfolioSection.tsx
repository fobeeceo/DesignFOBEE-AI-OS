 ...
 * 은평본점/단대점 이미지는 2026-07-27 CEO 확인 후 실제 매장에 맞게 교체됨.
 */
const GBRICK_STORES = [
  { name: "GBRICK Coffee 은평본점", location: "서울 은평구", meta: "직영 1호점 · 2013", image: "/images/portfolio/gbrick-eunpyeong.jpg" },
 ...
 * 공간 용도로만 표기, 2026-07-27 CEO 지시). "카페" 카테고리는 매장 카드와 일반 카페 사진이 함께 표시된다.
 */
